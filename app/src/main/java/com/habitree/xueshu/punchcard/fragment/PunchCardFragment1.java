 ...
 * 首页习惯界面
 */
public class PunchCardFragment1 extends BaseFragment implements View.OnClickListener, HabitView.HabitListView {
    ...
    public static PunchCardFragment1 newInstance() {
        Bundle args = new Bundle();
        PunchCardFragment1 fragment = new PunchCardFragment1();
